...
import com.tigerjoys.onion.communication.server.core.hotkey.CommandInfo;
import com.tigerjoys.onion.communication.server.core.session.DefaultSession;
...
public class BeatContext {
	...
	public void writeResponse() throws Exception {
		...
		LOGGER.debug("Server Response Message : " + FastJsonHelper.toJson(this.getResponse()));
