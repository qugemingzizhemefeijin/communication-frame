package com.tigerjoys.onion.communication.server.utils;
...
public abstract class Assert {
	...
	public static void hasLength(String text, String message) {
		if (!hasStringLength(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	
	private static boolean hasStringLength(CharSequence str) {
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (hasStringLength(textToSearch) && hasStringLength(substring) &&
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new IllegalArgumentException(
					(hasStringLength(message) ? message + " " : "") +
